<div class="grid" id="main_grid">
	<div class="onerow background_container margin_bottom">
		...
		<?php
			...
			echo $this->Form->label('Celebrity.firstName', 'first name',array('class' => 'clear'));
			...
			echo $this->Form->input('firstName',array('class' => 'clear'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.profileHeading1', 'profile heading 1',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.profileTextarea1', 'profile textarea 1');
			echo $this->Form->input('profileHeading1',array('class' => 'clear', 'placeholder'=>'left-hand side heading'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.profileHeading2', 'profile heading 2',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.profileTextarea2', 'profile textarea 2');
			echo $this->Form->input('profileHeading2',array('class' => 'clear', 'placeholder'=>'right-hand side heading'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.profileVideoLink1', 'profile video link 1',array('class' => 'clear'));
			...
			echo $this->Form->input('profileVideoLink1',array('class' => 'clear'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.outtakesTitle', 'outtakes title',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.outtakesQuote1', 'outtakes quote 1');
			echo $this->Form->input('outtakesTitle',array('class' => 'clear'));
			echo $this->Form->input('outtakesQuote1');
			echo '</div>';

			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.outtakesVideoLink1', 'outtakes video link 1',array('class' => 'clear'));
			...
			echo $this->Form->input('outtakesVideoLink1',array('class' => 'clear'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.outtakesHeading1', 'outtakes heading 1',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.outtakesTextarea1', 'outtakes textarea 1');
			echo $this->Form->input('outtakesHeading1',array('class' => 'clear', 'placeholder'=>'left-hand side heading'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.outtakesHeading2', 'outtakes heading 2',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.outtakesTextarea2', 'outtakes textarea 2');
			echo $this->Form->input('outtakesHeading2',array('class' => 'clear', 'placeholder'=>'middle heading'));
			...
			echo '<div class="input_row">';
			echo $this->Form->label('Celebrity.outtakesHeading3', 'outtakes heading 3',array('class' => 'clear'));
			echo $this->Form->label('Celebrity.outtakesTextarea3', 'outtakes textarea 3');
			echo $this->Form->input('outtakesHeading3',array('class' => 'clear', 'placeholder'=>'right-hand side heading'));
