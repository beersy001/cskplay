		...
		<div class="col7 last">
			<div class="col3">
				<ul>
					...
					<li><?= $this->Html->link('contact us',array('controller' => 'pages', 'action' => 'csk#section__contact-us'), array('class' => 'no-smoothstate')); ?></li>
			...
			<div class="col3 last">
				<ul>
					<li><?= $this->Html->link('sporting foundation',array('controller' => 'charities', 'action' => 'sportingFoundation')); ?></li>
