		...
		<div class="col12 form_container">
			...
			<form action="addCharity" method="post">
				<div class="input_row">
					...
					<input id="CharityName" class="clear" name="data[Charity][name]" placeholder="Name"  type="text">
				...
				<div class="input_row">
					...
					<input id="CharityHeading1" class="clear" name="data[Charity][heading1]" placeholder="heading 1" type="text">
				...
				<div class="input_row">
					...
					<input id="CharityHeading2" class="clear" name="data[Charity][heading2]" placeholder="heading 2" type="text">
				...
				<div class="input_row">
					...
					<input id="CharityHeading3" class="clear" name="data[Charity][heading3]" placeholder="heading 3" type="text">
				...
				<div class="input_row">
					...
					<input id="CharityHeading4" class="clear" name="data[Charity][heading4]" placeholder="heading 4" type="text">
