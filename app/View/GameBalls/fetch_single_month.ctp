	...
	<div class="col3">
		...
		?>
			<table class="icon_table">
				...
				echo '<p>you do not have any gameballs played in this team</p>';
			}
			?>
		</table>
	</div>
...
<div class="col6 last no_padding no_margin">
	<?php
	$imageSize = getimagesize('img/gameImages/'. $month . '/front_large.jpg');
	echo $this->Html->image( 'gameImages/'. $month . '/front_large.jpg', array('class'=>'game_image no_padding no_margin', 'id'=> 'mainImage_' . $imageSize[0] . '_' . $imageSize[1] .  '_' . $month) );
	?>
